...
NOTE: Older Java SE versions such as the LTS version 8 is not supported by deegree 3.5 and onward. 
...
choice. Afterwards, change to the directory ``deegree-webservices-tomcat-bundle-3.5.x/apache-tomcat-9.x.y/bin`` and
...
https://tomcat.apache.org/tomcat-9.0-doc/index.html[Tomcat documentation]

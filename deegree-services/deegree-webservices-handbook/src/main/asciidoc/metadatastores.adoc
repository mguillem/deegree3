...
The root element has to be _ISOMemoryMetadataStore_ with the only mandatory element being:
...
The root element has to be _ISOMetadataStore_ with the only mandatory element being:

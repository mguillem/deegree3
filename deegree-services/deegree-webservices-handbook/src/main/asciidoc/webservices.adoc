...
root element is <deegreeWFS> and the following table lists all available configuration options
...
element is _deegreeWMTS_, the following table lists all available configuration options. When
...
root element is _deegreeCSW_, the following table lists all available configuration options. When
